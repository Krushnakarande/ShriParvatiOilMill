package com.example.pariwaragro.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.example.pariwaragro.databinding.BuyAgainItemBinding

class BuyAgainAdapter(private val buyAgainItemName:ArrayList<String>,
                      private val buyAgainItemPrice:ArrayList<String>,
                      private val buyAgainItemImage:ArrayList<Int>) : RecyclerView.Adapter<BuyAgainAdapter.BuyAgainViewHolder>() {
